...
sys.path.append(str(Path.home() / "Projets" / "Cornelius" / "CORNIBU"))
...
from FUNC_viz_stacked_facets import visualize_stacked_facets
from FUNC_viz_corn_scene import visualize_corn_scene
...
def CORNIBU(T, To, DTc, DTs, S_max, N_max, H_max, inter_rang, density, 
    incli_top, incli_base, l, delta, phyllotactic_angle, phyllotactic_deviation, 
    loc, scale, arg, dist, Caribu, vizu, mode, norm, DOY, latitude, mode_AgriPV) :
    ...
    [ABC_stem, ABC_leaf, area_shape, longueur] = plante(
        N_max,S_max,H_max, incli_top, incli_base, l, delta
        )  # Design the 'mean' plante, that will be replicated | area_shape for LAI computation
    ...
    visualize_stacked_facets(Stacked_facets)
    ...
    path = '/Users/romzer-mac/CODE_PROJECTS/CORNIBU/corn/'
